...
function Dashboard() {
  ...
  return (
    <div className="flex">
      <div className="">
        {/* Sidebar */}
        <Sidebar createAssignement={toggleCreateAssignment} onClick={handleCardClick}/>
      </div>
      <div className="w-full">
        {/* Header */}
        <Navbar />
        {/* Main Content */}
        {addSubject?<AddSubject func={toggleAddSubject} val={addSubject} onClick={handleCardClick}/>:null}
        {createAssignement?<AddAssignment func={toggleCreateAssignment} onClick={handleCardClick}/>:null}
        {
          menu?
